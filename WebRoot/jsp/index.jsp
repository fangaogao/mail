...
<body>
	<div class="mianCont">
		...
		<div class="floor" id="floor1">
			...
			<div class="floorBox">
				<div class="floorLeft">
					...
					<!--flList/-->
					<div class="flImg">
						<img src="${ctx}/jsp/images/flListimg.jpg" width="198" height="290" />
					</div>
				</div>
				<!--floorLeft/-->
		...
		<!--floor/-->
		<div class="hengfu">
			<img src="${ctx}/jsp/images/hengfu2.jpg" width="978" height="97" />
		</div>
		<!--hengfu/-->
		...
		<!--floor/-->
		<div class="hengfu">
			<img src="${ctx}/jsp/images/hengfu1.jpg" width="978" height="97" />
		</div>
		<!--hengfu/-->
